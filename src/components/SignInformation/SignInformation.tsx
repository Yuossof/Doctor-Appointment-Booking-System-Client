...
export default function SignInformation(props: InformationData) {
    return (
        <div className='text-center'>
            <h1 className='text-dark-blue text-[50px] font-semibold'>{ props.title }</h1>
            <p className='text-body-text text-[13px]'>{ props.desc }</p>
            <Link
                href=''
                className='flex items-center justify-center gap-1 w-[800px] p-2 mt-6 border border-dark-blue rounded-lg'>
