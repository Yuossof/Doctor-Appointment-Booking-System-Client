...
import AddActionUser from '@/lib/services/Admin/AddActionUser'
...
export const AddUserBox = () => {
    const [state, action, pending] = useActionState<IData, FormData>(AddActionUser, initialState);
        ...
        <>
            {showBox && (
                <div
                    ...
                    <div className='absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 w-1/3'>
                        <motion.div
