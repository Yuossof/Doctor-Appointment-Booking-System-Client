            ...
            <div className='flex lg:gap-9 justify-center w-full px-3 lg:w-[80%] md:flex-row flex-col'>
                <div className='md:w-2/4 w-full flex flex-col gap-7 items-center md:items-start'>
                    <div className='flex flex-col items-start gap-4'>
                        ...
                        >Leave Your Worries At The Door And Enjoy A Healthier, More Precise Smile</h1>
                ...
                <div className='md:w-2/4 w-full flex justify-center md:justify-end'>
                    <div className='bg-white w-[80%]  px-4 py-5 flex flex-col gap-6 items-center rounded-md md:mt-0 mt-9'>
                        <h2 className='text-3xl text-dark-blue font-semibold mt-2'>Request Appointment</h2>
